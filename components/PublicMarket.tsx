...
export default function PublicMarket() {
  ...
  return <section className="public-market" id="piyasa">
    ...
    <div className="public-market-board">
      ...
      <div className="gold-market-note"><Coins size={21} /><span><b>Şeffaf hesaplama, doğru hukuki sınır</b><small>Gösterilen değerler saf metal karşılığına dayalı teknik referanstır; kuyumcu alış/satış fiyatı değildir. İşçilik, prim ve kurum makası içermez. Portalda firma tarafından onaylanan özel fiyat varsa o değer öncelikli kullanılır.</small></span></div>
